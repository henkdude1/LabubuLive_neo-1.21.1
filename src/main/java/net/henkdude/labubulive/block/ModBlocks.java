...
public class ModBlocks {
    public static final DeferredRegister<Block>BLOCKS=
            DeferredRegister.create(ForgeRegistries.BLOCKS, LabubuLive.MOD_ID);

    public static final RegistryObject<Block> LABUBU_BLINDBOX=registerBlock("labubu_blindbox",
